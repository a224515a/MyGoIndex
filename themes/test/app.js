...
function nav(path)
{
    ...
    <a href="https://github.com/a224515a/MyGoIndex/" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'GoIndex Drive on Github'}">
...
function utc2Taipei(utc_datetime)
{
    ...
    // Add 8 hours, Taipei time is eight more time zones than UTC time
